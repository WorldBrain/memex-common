...
export type MediaChangeInfo = HtmlBodyMediaChangeInfo | FavIconMediaChangeInfo

export interface HtmlBodyMediaChangeInfo {
    type: 'htmlBody'
    normalizedUrl: string
}

export interface FavIconMediaChangeInfo {
    type: 'favIcon'
    hostname: string
}
